...
for(let i = 0; i < githubData.length; i++) {
    ...
    if (typeId === "PushEvent") {
        ...
        typePull += 1;
        requesters.push(" " + githubData[i].payload.pull_request.user.login);
    } else if (typeId === "DeleteEvent"){
        typeDelete += 1;
    } else if (typeId === "IssueCommentEvent") {
        typeIssue +=1;
    } else {
        typeCreate += 1;
    }
...
console.log(`Total number of Push Events: ${typePush}`);
console.log(`Total number of Pull Request Events: ${typePull}`);
console.log(`Total number of Delete Events ${typeDelete}`);
console.log(`Total number of Issue Comment Events ${typeIssue}`);
console.log(`Total number of Create Events ${typeCreate}`);
console.log(`Steve Brownlee reviewed requests from ${requesters}`);
...
console.log(`The list of repositories used is: ${repoList}`);
...
console.log(eventMastery);
console.log(eventBangazon);
